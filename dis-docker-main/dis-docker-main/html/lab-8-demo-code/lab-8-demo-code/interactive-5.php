      ...
      <?php       
        ...
        if (mysqli_num_rows($result) > 0) 
        {
           ...
           while($row = mysqli_fetch_assoc($result)) 
           {
             ...
             //The "nbsp" in the given code represents a non-breaking space
             //in HTML. In HTML, normal spaces are collapsed into a single 
             //space, but a non-breaking space prevents this collapsing and 
             //ensures that the content after it is not broken into a new line.
